...
I build **real-world management systems**, authentication architectures, reporting dashboards, and structured administrative workflows.  
...
**Mobile:** Flutter  
**Tools & Concepts:** Git & GitHub, MVC Architecture, Database Design, System Architecture, Workflow Automation  
...
- Dynamic report generation (PDF & CSV)  
- AJAX-based filtering and data visualization  

> This project demonstrates **real-world problem solving**, structured backend logic, and scalable administrative architecture.  

[View Project →](#) *(link to repo once uploaded)*
...
🔗 LinkedIn: [yourprofile](https://www.linkedin.com/in/muthai-titus-muthoka/)  
